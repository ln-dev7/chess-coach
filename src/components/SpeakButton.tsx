 ...
 * there's no text.
 *
 * Pass `id` to share play/stop state with an external controller (e.g. an
 * auto-reader). Pass `onPlay` to override what "play" does (e.g. start a
 * block-by-block sequence); stop always cancels.
 */
