/**
 * App logo — chess rook from Tabler Icons (MIT license).
 * https://tabler.io/icons/icon/chess-rook
 */
export default function Logo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <span className="inline-flex items-center justify-center rounded-lg bg-emerald-500/15 p-1.5">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`${className} text-emerald-400`} aria-hidden>
